...
export const conversations: Conversation[] = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        senderId: '1',
        receiverId: 'current_user',
        content: 'Merhaba! Proje planlandığı gibi ilerliyor. Bu hafta frontend kısmını bitirmeyi hedefliyoruz.',
      ...
      },
      {
        ...
        senderId: '1',
        receiverId: 'current_user',
        content: 'Evet, Mehmet\'in hazırladığı API\'lar test edildi. Yarın deployment yapabiliriz.',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        senderId: '2',
        receiverId: 'current_user',
        content: 'Teşekkürler! Kullanıcı deneyimini ön planda tutmaya çalıştım.',
        timestamp: new Date(Date.now() - 1 * 60 * 60 * 1000),
        type: 'text',
        isRead: true
      },
