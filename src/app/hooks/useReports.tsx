...
export const useReports = () => {
  ...
  // State management
  const [topSidebarActive, setTopSidebarActive] = useState<'write' | 'history'>('write');
  const [bottomSidebarActive, setBottomSidebarActive] = useState<'people' | 'filters'>('people');
