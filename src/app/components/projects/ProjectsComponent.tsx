      ...
      <div className="mb-8">
            ...
            {projects.map((project, index) => {
              ...
              return (
                <div
                  ...
                  className={`group relative backdrop-blur-sm rounded-3xl p-6 shadow-lg border cursor-pointer transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 animate-fadeInUp ${
                    theme === 'dark'
                ...
                >
                  ...
                  <div className={`absolute top-0 left-0 w-full h-1 ${
                    priorityColor === 'red' ? 'bg-gradient-to-r from-red-500 to-pink-500' :
                    priorityColor === 'yellow' ? 'bg-gradient-to-r from-yellow-500 to-orange-500' :
                    priorityColor === 'green' ? 'bg-gradient-to-r from-green-500 to-emerald-500' :
                  ...
                  <div className="pt-4">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <h3 className={`text-xl font-bold leading-tight group-hover:text-indigo-600 transition-colors duration-300 ${
                          theme === 'dark' ? 'text-white' : 'text-gray-900'
                        }`}>{project.name}</h3>
                      ...
                      <div className="flex justify-start">
                        <span className={`inline-flex items-center px-4 py-2 rounded-full text-xs font-semibold border-2 transition-all duration-300 ${
                          project.status === 'planning' ? 
                            theme === 'dark' ? 'bg-yellow-800 text-yellow-100 border-yellow-600' : 'bg-yellow-100 text-yellow-800 border-yellow-200' :
                          project.status === 'active' ? 
                            theme === 'dark' ? 'bg-green-800 text-green-100 border-green-600' : 'bg-green-100 text-green-800 border-green-200' :
                          project.status === 'paused' ? 
                            theme === 'dark' ? 'bg-orange-800 text-orange-100 border-orange-600' : 'bg-orange-100 text-orange-800 border-orange-200' :
                          project.status === 'completed' ? 
                            theme === 'dark' ? 'bg-blue-800 text-blue-100 border-blue-600' : 'bg-blue-100 text-blue-800 border-blue-200' :
                            theme === 'dark' ? 'bg-gray-800 text-gray-100 border-gray-600' : 'bg-gray-100 text-gray-800 border-gray-200'
                        }`}>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-opacity-20 border-gray-300">
                    <div className={`flex items-center space-x-4 text-sm ${
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="font-medium">{project.assignedMembers.length} Üye</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium ${
                          theme === 'dark' 
                        ...
                        <span className="font-medium">{project.tasks.length} Görev</span>
                      </div>
                    </div>
        ...
        {projects.length === 0 && (
          <div className="text-center py-16">
            <div className={`relative mx-auto mb-8 w-24 h-24 rounded-full flex items-center justify-center ${
              theme === 'dark' 
              ...
              <FolderOpen className={`w-10 h-10 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`} />
            </div>
            ...
            <p className={`text-lg mb-6 max-w-md mx-auto ${
              ...
              İlk projenizi oluşturarak başlayın ve ekibinizle birlikte çalışmaya başlayın.
            </p>
            <button
              onClick={openCreateModal}
            ...
            <div className={`inline-block px-6 py-3 rounded-full text-sm font-medium mt-4 ${
              theme === 'dark'
