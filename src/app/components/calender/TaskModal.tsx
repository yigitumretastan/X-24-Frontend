				...
				<div className="px-6 pb-6 space-y-6">
					...
					<div className="space-y-2">
						...
						<div className="relative">
							<select
								...
								value={form.typeId}
								onChange={(e) =>
									setForm((f) => ({ ...f, typeId: Number(e.target.value) }))
								}
							>
								{taskTypes.map((type) => (
									<option
							...
							<div className="absolute left-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
								<div
									...
									style={{
										backgroundColor:
											taskTypes.find((t) => t.id === form.typeId)?.color ||
											"#6366f1",
									}}
								/>
							</div>
					...
					{editingTask && (
						<div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200">
							...
							<label
								htmlFor="completed"
								className="flex items-center space-x-2 text-sm font-medium text-gray-900 cursor-pointer"
							>
