	...
	return (
		<div className="relative w-full max-w-sm group">
			...
			>
				...
				{searchTerm && (
					<div
						className={`absolute right-4 top-1/2 transform -translate-y-1/2 flex items-center space-x-1 ${
			...
			{searchTerm && (
				<div
					className={`absolute -top-2 left-4 px-2 text-xs font-medium transition-all duration-300 ${
						theme.theme === "dark"
