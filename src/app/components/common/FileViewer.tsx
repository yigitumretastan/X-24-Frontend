...
export default function FileViewer({
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center">
			...
			<button
				type="button"
				className="absolute inset-0 bg-black/80 backdrop-blur-sm w-full h-full border-none"
				onClick={onClose}
				aria-label="Kapat"
			/>
			...
			{/* Modal */}
			<div
				className={`relative w-full h-full max-w-7xl max-h-[90vh] m-4 rounded-3xl overflow-hidden ${
					theme === "dark"
